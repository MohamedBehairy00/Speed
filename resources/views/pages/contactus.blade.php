@extends('Shared.headcontactus')

@section('content')
    <!--{Start Contact Us Section} -->
    <div class="nav_contact">
        <section class="container wow animate__animated animate__zoomIn">
            <h1 class="CONTACTUS-page bebas-neue-regular">Contact Us</h1>
            <p class="breadcrumb bebas-neue-regular">ABOUT &rarr; CONTACT US</p>
            <div class="contact-info">
                <div class="info wow animate__animated animate__fadeInUp">
                    <h3 class="info_header bebas-neue-regular">contact with phone number</h3>
                    <p class="info_parag">+2 01006874248</p>
                    <p class="info_parag">+2 01009870077</p>
                </div>
                <div class="info-2 wow animate__animated animate__fadeInUp">
                    <h3 class="info_header bebas-neue-regular">email address</h3>
                    <p class="info_parag">speed@speed-advertising.com</p>
                    <p class="info_parag">hr@speed-advertising.com</p>
                </div>
                <div class="info-3 wow animate__animated animate__fadeInUp">
                    <h3 class="info_header bebas-neue-regular">location</h3>
                    <p class="info_parag">5 gamal Ezz Elden Salama St., From Abd El Hamed Badawy, El Higaz, Cairo.
                        Egypt.</p>
                </div>
            </div>
        </section>
    ...
    <div class="background-form-contactus ">
        <div class="container container-form d-flex justify-content-between ">
            <div class="left-section wow animate__animated animate__zoomIn mb-5">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 790 563" fill="none" class="svg-contactus">
                    <g id="Image">
                        <g id="g14">
                            <g id="g16">
                                <g id="g22">
            ...
            <div class="right-section wow animate__animated animate__flipInX" style="animation-duration: 2s;">
                <div class="contact-form">
                    <div class="logo-Form">
                        <img class="Logoo-form" src="{{ asset('assets/images/logo-form.png') }}">
                    </div>
                    ...
                    <form id="contactForm" action="{{ route('create.store') }}" method="POST" onsubmit="return handleSubmit(event)">
                        @csrf
                        ...
                        <input type="text" name="company" placeholder="COMPANY NAME" class="form-control"
                            value="{{ old('company') }}">
                        <textarea name="message" placeholder="Message" rows="4" class="form-control">{{ old('message') }}</textarea>
                        <div id="captchaContainer"></div>

                        <div class="button-contactus mx-auto wow animate__animated animate__fadeInUp ">
                            <button type="submit">
                                <span></span>
                                <span></span>
                                <span></span>
    ...
    <div class="map-container">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3451.210750679808!2d31.343379087747547!3d30.116782350401284!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMzDCsDA3JzAwLjQiTiAzMcKwMjAnNTMuNyJF!5e0!3m2!1sen!2seg!4v1723472836561!5m2!1sen!2seg"
